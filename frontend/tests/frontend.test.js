...
describe('apiCall()', () => {
  test('include Authorization: Bearer quando il token è presente', async () => {
    ...
    win._accessToken = 'my-test-token';
...
describe('clearAll()', () => {
  test('aggiorna la cache localStorage con array vuoto dopo la cancellazione', async () => {
    // Call 1 (boot refresh): 200 empty (no accessToken)
    // Call 2 (boot GET /api/cans): restituisce array vuoto
    // Call 3 (clearAll DELETE /api/cans): restituisce 204
    const fetchImpl = jest.fn()
